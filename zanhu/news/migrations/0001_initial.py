# Generated by Django 2.2 on 2020-01-23 16:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked', models.ManyToManyField(related_name='liked_name', to=settings.AUTH_USER_MODEL, verbose_name='点赞用户')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='thread', to='news.News', verbose_name='评论自关联')),
