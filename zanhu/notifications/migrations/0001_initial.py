# Generated by Django 2.2 on 2020-02-11 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verb', models.CharField(choices=[('L', '赞了'), ('C', '评论了'), ('F', '收藏了'), ('A', '回答了'), ('W', '接收了回答'), ('R', '回复了'), ('I', '登录'), ('O', '退出')], max_length=1, verbose_name='通知类型')),
                ...
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_actor', to=settings.AUTH_USER_MODEL, verbose_name='接收者')),
            ],
            options={
                'verbose_name': '通知',
